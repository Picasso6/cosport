...
task create_events_daily: :environment do
  ...
  Event.create!(title: "Foot à la citadelle", description: "Ramenez vos meilleures baskets", start_date: date6, duration: 30, city_id: 6, sport_id: 1 ,owner_id: 1, latitude:  50.640169, longitude:  3.066667)
